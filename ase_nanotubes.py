...
from mpl_toolkits.mplot3d import Axes3D  # necessary even if not used
...
positions = cnt2.positions # atoms coordinates
dist = sc.cdist(positions,positions) # all distances between every atom pair O(n^2)!!
